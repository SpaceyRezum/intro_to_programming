var bio = {
    "name": "Alexis Bellet",
    "age": 26,
    "position": "Trilingual Digital Marketer Specialized in Search Marketing",
    "contacts": {
        "email": "info@alexis-bellet.com",
        "phone": "+336/42/36/77/37",
...
var work_experience = {
    "jobs": [{
        ...
        "website": "http://www.reportlinker.com/"
    }, {
        "name": "Ben & Jerry's D-A-CH",
        "position": "Brand Building (Paid Internship)",
        "dates": "03/14 - 09/14",
        ...
        "website": "http://www.benjerry.de/"
    }, {
        "name": "POGED.com",
        "position": "Country Manager France (Part Time)",
        "dates": "11/12 - 01/14",
        "location": "Hamburg, Germany",
        ...
        "website": "http://us.poged.com/"
    }, {
        "name": "Zalando",
        "position": "Content Marketing & SEO (Paid Internship)",
        "dates": "10/11 - 09/12",
        ...
        "<ul><li>Websites oerformance analysis</li>" +
...
var education = {
    "schools": [{
        ...
        "yearsAttended": "2012-2015 (including 6-month internship)",
        "city": "Hamburg, Germany",
        "website": "https://www.wiso.uni-hamburg.de/studienbuero-sozialoekonomie/studiengaenge/ma-mibas.html"
    }, {
        "name": "Nottingham Trent University",
        "degree": "BA",
        "major": "Marketing Management",
        "yearsAttended": "2010-2011",
        "city": "Notthingham, United Kingdom",
        "website": "https://www.ntu.ac.uk/study-and-courses/courses/find-your-course/business/ug/2017-18/marketing"
    }, {
        ...
        "website": "http://www.iut2.upmf-grenoble.fr/international-/study-at-iut2-grenoble/i-wish-to-study-at-iut2/business-and-marketing-278277.htm"
    }],
    "onlineCourses": [{
...
bio.display = function() {
    ...
    var formattedHeaderRole = HTMLheaderRole.replace("%data%", bio.position);
    var formattedHeaderPic = HTMLbioPic.replace("%data%", bio.biopic);
    $("#header").prepend(formattedHeaderRole).prepend(formattedHeaderName);
    $("#header").append("<div id='belowDetails'></div>");
    $("#belowDetails").append(formattedHeaderPic);
    $("#belowDetails").append(HTMLwelcomeMsg.replace("%data%", bio.welcomeMessage));
...
work_experience.display = function() {
    // Insertion of the work experience section
    (work_experience.jobs).forEach(function(job) {
        $("#workExperience").append(HTMLworkStart);
        var formattedJobTitle = HTMLworkEmployer.replace("%data%", job.name).replace("#", job.website) + HTMLworkTitle.replace("%data%", job.position);
...
education.display = function() {
    ...
    $("#education").append(HTMLuniversities);
    $("#education").append(HTMLonlineClasses);
    (education.schools).forEach(function(school) {
        $("#universities").append(HTMLschoolStart);
        var formattedSchool = HTMLschoolName.replace("%data%", school.name).replace("#", school.website) + HTMLschoolDegree.replace("%data%", school.degree) + HTMLschoolMajor.replace("%data%", school.major);
        $(".education-entry:last").append(formattedSchool);
        $(".education-entry:last").append(HTMLschoolDates.replace("%data%", school.yearsAttended));
    ...
    (education.onlineCourses).forEach(function(school) {
        ...
        $(".education-entry:last").append(HTMLschoolLocation.replace("%data%", school.school));
    });
};
